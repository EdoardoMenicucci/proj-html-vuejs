...
export default {
    ...
    methods: {
        ...
        mouseRelease() {
            ...
            this.isSmooth = true;
            console.log(this.isClicked, this.isSmooth);
        },
...
<template>
    ...
    <div class="container">
        ...
        <div id="carousel" :class="{ smooth: isSmooth }" @mousemove="dragging"
            ...
            <div v-for="elemento in store.carouselData" id="element-container">
                <div class="elemento black" :class="{ snapalign: isSmooth }">
